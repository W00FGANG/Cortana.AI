...
export default function OperationsPage() {
  const activityLog = [
    { id: 1, agent: "Kai", action: "Started sales research task", timestamp: "10:45 AM", status: "Running" },
    { id: 2, agent: "Atlas", action: "Discovered 8 potential prospects", timestamp: "10:42 AM", status: "Success" },
    ...
    { id: 5, agent: "Kai", action: "Failed to connect to CRM API", timestamp: "Yesterday, 4:30 PM", status: "Failed" },
  ];
    ...
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      <header className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-slate-500 mt-1">Global activity log for all AI workers.</p>
        </div>
        <div className="flex items-center gap-3">
          <div className="relative">
            ...
            <input 
              ...
              className="pl-9 pr-4 py-2 text-sm border border-slate-200 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent w-64"
            />
          </div>
